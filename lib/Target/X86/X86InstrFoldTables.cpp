...
static const X86MemoryFoldTableEntry MemoryFoldTable0[] = {
  ...
  { X86::MOV16ri,             X86::MOV16mi,             TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOV16rr,             X86::MOV16mr,             TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOV32ri,             X86::MOV32mi,             TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOV32rr,             X86::MOV32mr,             TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOV64ri32,           X86::MOV64mi32,           TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOV64rr,             X86::MOV64mr,             TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOV8ri,              X86::MOV8mi,              TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOV8rr,              X86::MOV8mr,              TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOV8rr_NOREX,        X86::MOV8mr_NOREX,        TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOVAPDrr,            X86::MOVAPDmr,            TB_FOLDED_STORE | TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  { X86::MOVAPSrr,            X86::MOVAPSmr,            TB_FOLDED_STORE | TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  { X86::MOVDQArr,            X86::MOVDQAmr,            TB_FOLDED_STORE | TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  { X86::MOVDQUrr,            X86::MOVDQUmr,            TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOVPDI2DIrr,         X86::MOVPDI2DImr,         TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOVPQIto64rr,        X86::MOVPQI2QImr,         TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOVSDto64rr,         X86::MOVSDto64mr,         TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOVSS2DIrr,          X86::MOVSS2DImr,          TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOVUPDrr,            X86::MOVUPDmr,            TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MOVUPSrr,            X86::MOVUPSmr,            TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::MUL16r,              X86::MUL16m,              TB_FOLDED_LOAD },
  { X86::MUL32r,              X86::MUL32m,              TB_FOLDED_LOAD },
  { X86::MUL64r,              X86::MUL64m,              TB_FOLDED_LOAD },
  { X86::MUL8r,               X86::MUL8m,               TB_FOLDED_LOAD },
  { X86::PEXTRDrr,            X86::PEXTRDmr,            TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::PEXTRQrr,            X86::PEXTRQmr,            TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVAPDYrr,          X86::VMOVAPDYmr,          TB_FOLDED_STORE | TB_ALIGN_32 | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVAPDZ128rr,       X86::VMOVAPDZ128mr,       TB_FOLDED_STORE | TB_ALIGN_16 },
  { X86::VMOVAPDZ256rr,       X86::VMOVAPDZ256mr,       TB_FOLDED_STORE | TB_ALIGN_32 },
  { X86::VMOVAPDZrr,          X86::VMOVAPDZmr,          TB_FOLDED_STORE | TB_ALIGN_64 },
  { X86::VMOVAPDrr,           X86::VMOVAPDmr,           TB_FOLDED_STORE | TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVAPSYrr,          X86::VMOVAPSYmr,          TB_FOLDED_STORE | TB_ALIGN_32 | TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVAPSrr,           X86::VMOVAPSmr,           TB_FOLDED_STORE | TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVDQAYrr,          X86::VMOVDQAYmr,          TB_FOLDED_STORE | TB_ALIGN_32 | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVDQArr,           X86::VMOVDQAmr,           TB_FOLDED_STORE | TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVDQUYrr,          X86::VMOVDQUYmr,          TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVDQUrr,           X86::VMOVDQUmr,           TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVPDI2DIZrr,       X86::VMOVPDI2DIZmr,       TB_FOLDED_STORE },
  { X86::VMOVPDI2DIrr,        X86::VMOVPDI2DImr,        TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVPQIto64Zrr,      X86::VMOVPQI2QIZmr,       TB_FOLDED_STORE },
  { X86::VMOVPQIto64rr,       X86::VMOVPQI2QImr,        TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVSDto64Zrr,       X86::VMOVSDto64Zmr,       TB_FOLDED_STORE },
  { X86::VMOVSDto64rr,        X86::VMOVSDto64mr,        TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVSS2DIZrr,        X86::VMOVSS2DIZmr,        TB_FOLDED_STORE },
  { X86::VMOVSS2DIrr,         X86::VMOVSS2DImr,         TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVUPDYrr,          X86::VMOVUPDYmr,          TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVUPDrr,           X86::VMOVUPDmr,           TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVUPSYrr,          X86::VMOVUPSYmr,          TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVUPSrr,           X86::VMOVUPSmr,           TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::VPEXTRDZrr,          X86::VPEXTRDZmr,          TB_FOLDED_STORE },
  { X86::VPEXTRDrr,           X86::VPEXTRDmr,           TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
  { X86::VPEXTRQZrr,          X86::VPEXTRQZmr,          TB_FOLDED_STORE },
  { X86::VPEXTRQrr,           X86::VPEXTRQmr,           TB_FOLDED_STORE | TB_MUST_FORWARD_ENTRY },
...
static const X86MemoryFoldTableEntry MemoryFoldTable1[] = {
  ...
  { X86::MOV64toPQIrr,         X86::MOVQI2PQIrm,          TB_MUST_FORWARD_ENTRY },
  { X86::MOV64toSDrr,          X86::MOV64toSDrm,          TB_MUST_FORWARD_ENTRY },
  { X86::MOV8rr,               X86::MOV8rm,               TB_MUST_FORWARD_ENTRY },
  { X86::MOVAPDrr,             X86::MOVAPDrm,             TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  { X86::MOVAPSrr,             X86::MOVAPSrm,             TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  { X86::MOVDDUPrr,            X86::MOVDDUPrm,            TB_NO_REVERSE },
  { X86::MOVDI2PDIrr,          X86::MOVDI2PDIrm,          TB_MUST_FORWARD_ENTRY },
  { X86::MOVDI2SSrr,           X86::MOVDI2SSrm,           TB_MUST_FORWARD_ENTRY },
  { X86::MOVDQArr,             X86::MOVDQArm,             TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  { X86::MOVDQUrr,             X86::MOVDQUrm,             TB_MUST_FORWARD_ENTRY },
  { X86::MOVSHDUPrr,           X86::MOVSHDUPrm,           TB_ALIGN_16 },
  { X86::MOVSLDUPrr,           X86::MOVSLDUPrm,           TB_ALIGN_16 },
  { X86::MOVSX16rr8,           X86::MOVSX16rm8,           TB_MUST_FORWARD_ENTRY },
  { X86::MOVSX32rr16,          X86::MOVSX32rm16,          TB_MUST_FORWARD_ENTRY },
  { X86::MOVSX32rr8,           X86::MOVSX32rm8,           TB_MUST_FORWARD_ENTRY },
  { X86::MOVSX32rr8_NOREX,     X86::MOVSX32rm8_NOREX,     TB_MUST_FORWARD_ENTRY },
  { X86::MOVSX64rr16,          X86::MOVSX64rm16,          TB_MUST_FORWARD_ENTRY },
  { X86::MOVSX64rr32,          X86::MOVSX64rm32,          TB_MUST_FORWARD_ENTRY },
  { X86::MOVSX64rr8,           X86::MOVSX64rm8,           TB_MUST_FORWARD_ENTRY },
  { X86::MOVUPDrr,             X86::MOVUPDrm,             TB_MUST_FORWARD_ENTRY },
  { X86::MOVUPSrr,             X86::MOVUPSrm,             TB_MUST_FORWARD_ENTRY },
  { X86::MOVZPQILo2PQIrr,      X86::MOVQI2PQIrm,          TB_NO_REVERSE },
  { X86::MOVZX16rr8,           X86::MOVZX16rm8,           TB_MUST_FORWARD_ENTRY },
  { X86::MOVZX32rr16,          X86::MOVZX32rm16,          TB_MUST_FORWARD_ENTRY },
  { X86::MOVZX32rr8,           X86::MOVZX32rm8,           TB_MUST_FORWARD_ENTRY },
  { X86::MOVZX32rr8_NOREX,     X86::MOVZX32rm8_NOREX,     TB_MUST_FORWARD_ENTRY },
  { X86::MOVZX64rr16,          X86::MOVZX64rm16,          TB_MUST_FORWARD_ENTRY },
  { X86::MOVZX64rr8,           X86::MOVZX64rm8,           TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOV64toPQIrr,        X86::VMOVQI2PQIrm,         TB_MUST_FORWARD_ENTRY },
  { X86::VMOV64toSDZrr,        X86::VMOV64toSDZrm,        0 },
  { X86::VMOV64toSDrr,         X86::VMOV64toSDrm,         TB_MUST_FORWARD_ENTRY },
  { X86::VMOVAPDYrr,           X86::VMOVAPDYrm,           TB_ALIGN_32 | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVAPDZ128rr,        X86::VMOVAPDZ128rm,        TB_ALIGN_16 },
  { X86::VMOVAPDZ256rr,        X86::VMOVAPDZ256rm,        TB_ALIGN_32 },
  { X86::VMOVAPDZrr,           X86::VMOVAPDZrm,           TB_ALIGN_64 },
  { X86::VMOVAPDrr,            X86::VMOVAPDrm,            TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVAPSYrr,           X86::VMOVAPSYrm,           TB_ALIGN_32 | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVAPSZ128rr,        X86::VMOVAPSZ128rm,        TB_ALIGN_16 },
  { X86::VMOVAPSZ256rr,        X86::VMOVAPSZ256rm,        TB_ALIGN_32 },
  { X86::VMOVAPSZrr,           X86::VMOVAPSZrm,           TB_ALIGN_64 },
  { X86::VMOVAPSrr,            X86::VMOVAPSrm,            TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVDI2PDIrr,         X86::VMOVDI2PDIrm,         TB_MUST_FORWARD_ENTRY },
  { X86::VMOVDI2SSZrr,         X86::VMOVDI2SSZrm,         0 },
  { X86::VMOVDI2SSrr,          X86::VMOVDI2SSrm,          TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVDQAYrr,           X86::VMOVDQAYrm,           TB_ALIGN_32 | TB_MUST_FORWARD_ENTRY },
  { X86::VMOVDQArr,            X86::VMOVDQArm,            TB_ALIGN_16 | TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVDQUYrr,           X86::VMOVDQUYrm,           TB_MUST_FORWARD_ENTRY },
  { X86::VMOVDQUrr,            X86::VMOVDQUrm,            TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVUPDYrr,           X86::VMOVUPDYrm,           TB_MUST_FORWARD_ENTRY },
  { X86::VMOVUPDZ128rr,        X86::VMOVUPDZ128rm,        0 },
  { X86::VMOVUPDZ256rr,        X86::VMOVUPDZ256rm,        0 },
  { X86::VMOVUPDZrr,           X86::VMOVUPDZrm,           0 },
  { X86::VMOVUPDrr,            X86::VMOVUPDrm,            TB_MUST_FORWARD_ENTRY },
  { X86::VMOVUPSYrr,           X86::VMOVUPSYrm,           TB_MUST_FORWARD_ENTRY },
  { X86::VMOVUPSZ128rr,        X86::VMOVUPSZ128rm,        0 },
  { X86::VMOVUPSZ256rr,        X86::VMOVUPSZ256rm,        0 },
  { X86::VMOVUPSZrr,           X86::VMOVUPSZrm,           0 },
  { X86::VMOVUPSrr,            X86::VMOVUPSrm,            TB_MUST_FORWARD_ENTRY },
...
static const X86MemoryFoldTableEntry MemoryFoldTable2[] = {
  ...
  { X86::PINSRBrr,                 X86::PINSRBrm,                 TB_NO_REVERSE | TB_MUST_FORWARD_ENTRY },
  { X86::PINSRDrr,                 X86::PINSRDrm,                 TB_MUST_FORWARD_ENTRY },
  { X86::PINSRQrr,                 X86::PINSRQrm,                 TB_MUST_FORWARD_ENTRY },
  { X86::PINSRWrr,                 X86::PINSRWrm,                 TB_NO_REVERSE | TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VMOVLHPSrr,               X86::VMOVHPSrm,                TB_NO_REVERSE | TB_MUST_FORWARD_ENTRY },
  ...
  { X86::VPINSRBrr,                X86::VPINSRBrm,                TB_NO_REVERSE | TB_MUST_FORWARD_ENTRY },
  { X86::VPINSRDZrr,               X86::VPINSRDZrm,               0 },
  { X86::VPINSRDrr,                X86::VPINSRDrm,                TB_MUST_FORWARD_ENTRY },
  { X86::VPINSRQZrr,               X86::VPINSRQZrm,               0 },
  { X86::VPINSRQrr,                X86::VPINSRQrm,                TB_MUST_FORWARD_ENTRY },
  { X86::VPINSRWZrr,               X86::VPINSRWZrm,               TB_NO_REVERSE },
  { X86::VPINSRWrr,                X86::VPINSRWrm,                TB_NO_REVERSE | TB_MUST_FORWARD_ENTRY },
