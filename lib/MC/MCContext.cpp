...
MCCartridgeRecord *MCContext::createCartridgeRecord(MCSymbol *cartridge, std::string function) {
  MCCartridgeRecord *record = new (*this) MCCartridgeRecord(cartridge, function, this);
